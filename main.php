...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0; color:#FF0">
           ...
           <!--  dddddddddd -->
 <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;"><?php echo  $_SESSION['user']; ?>  &nbsp; <div class="btn-group pull-right">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                      ...
                      <li  >
                        <?php
                      echo" <li><a class='active-menu'  href='main.php'><i class='fa fa-keyboard-o fa-2x'></i>Expense</a></li>";
                      ?>
